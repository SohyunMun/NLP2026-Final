...
Sonnet generation 전용 데이터는 `sonnet_data/` 아래에 canonical layout으로 정리했다.

| group | split | file | count |
|---|---|---|---:|
| basic | train | `sonnet_data/basic/train_131.txt` | 131 |
| basic | dev prompts | `sonnet_data/basic/dev_prompts_12.txt` | 12 |
| basic | dev gold | `sonnet_data/basic/dev_gold_12.txt` | 12 |
| basic | test prompts | `sonnet_data/basic/test_prompts_12.txt` | 12 |
| strict_497 | official train | `sonnet_data/strict_497/official_train_131.txt` | 131 |
| strict_497 | strict extra train | `sonnet_data/strict_497/extra_train_strict_497.txt` | 497 |
| strict_497 | combined train | `sonnet_data/strict_497/train_official_131_plus_extra_497_total_628.txt` | 628 |
| strict_497 | dev prompts | `sonnet_data/strict_497/dev_prompts_12.txt` | 12 |
| strict_497 | dev gold | `sonnet_data/strict_497/dev_gold_12.txt` | 12 |
| strict_497 | test prompts | `sonnet_data/strict_497/test_prompts_12.txt` | 12 |
...
정제 기록은 `sonnet_data/docs/strict_497_manifest.md`에 저장되어 있다.
...
평가 스크립트는 `evaluate_sonnet_poemetric.py`이다. 이 스크립트는 CPU-only로 동작하며, 생성 결과 텍스트, prompt, gold reference를 읽어 지표를 계산한다.
...
| optimizer | AdamW |
| batch size | 8 |
| primary dev split | `sonnet_data/strict_497/dev_prompts_12.txt` |
| dev gold | `sonnet_data/strict_497/dev_gold_12.txt` |
| test split | `sonnet_data/strict_497/test_prompts_12.txt` |
| hardware | GPU 0,1,2,3 parallel scheduling |
| final runner | `run_sixway_sonnet_ablation.py` |
